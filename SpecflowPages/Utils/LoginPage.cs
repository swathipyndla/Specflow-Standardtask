  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[@name='email']")).SendKeys("pyndlaswathi@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//input[@type='password']")).SendKeys("swathikanth");
            Thread.Sleep(1000);
